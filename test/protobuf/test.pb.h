...
namespace test {
class GetFriendLsitRequest;
struct GetFriendLsitRequestDefaultTypeInternal;
extern GetFriendLsitRequestDefaultTypeInternal _GetFriendLsitRequest_default_instance_;
class GetFriendLsitResponse;
struct GetFriendLsitResponseDefaultTypeInternal;
extern GetFriendLsitResponseDefaultTypeInternal _GetFriendLsitResponse_default_instance_;
class LoginRequest;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::test::GetFriendLsitRequest* Arena::CreateMaybeMessage<::test::GetFriendLsitRequest>(Arena*);
template<> ::test::GetFriendLsitResponse* Arena::CreateMaybeMessage<::test::GetFriendLsitResponse>(Arena*);
...
class GetFriendLsitRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:test.GetFriendLsitRequest) */ {
 public:
  inline GetFriendLsitRequest() : GetFriendLsitRequest(nullptr) {}
  ~GetFriendLsitRequest() override;
  explicit PROTOBUF_CONSTEXPR GetFriendLsitRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GetFriendLsitRequest(const GetFriendLsitRequest& from);
  GetFriendLsitRequest(GetFriendLsitRequest&& from) noexcept
    : GetFriendLsitRequest() {
    *this = ::std::move(from);
  }

  inline GetFriendLsitRequest& operator=(const GetFriendLsitRequest& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriendLsitRequest& operator=(GetFriendLsitRequest&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const GetFriendLsitRequest& default_instance() {
    return *internal_default_instance();
  }
  static inline const GetFriendLsitRequest* internal_default_instance() {
    return reinterpret_cast<const GetFriendLsitRequest*>(
               &_GetFriendLsitRequest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(GetFriendLsitRequest& a, GetFriendLsitRequest& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriendLsitRequest* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(GetFriendLsitRequest* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  GetFriendLsitRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GetFriendLsitRequest>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GetFriendLsitRequest& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const GetFriendLsitRequest& from) {
    GetFriendLsitRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriendLsitRequest* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "test.GetFriendLsitRequest";
  }
  protected:
  explicit GetFriendLsitRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:test.GetFriendLsitRequest)
 private:
  class _Internal;
...
class User final :
 ...
 public:
  ...
  void clear_gender();
  ::test::User_Gender gender() const;
  void set_gender(::test::User_Gender value);
  private:
  ::test::User_Gender _internal_gender() const;
  void _internal_set_gender(::test::User_Gender value);
  public:
...
class GetFriendLsitResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:test.GetFriendLsitResponse) */ {
 public:
  inline GetFriendLsitResponse() : GetFriendLsitResponse(nullptr) {}
  ~GetFriendLsitResponse() override;
  explicit PROTOBUF_CONSTEXPR GetFriendLsitResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GetFriendLsitResponse(const GetFriendLsitResponse& from);
  GetFriendLsitResponse(GetFriendLsitResponse&& from) noexcept
    : GetFriendLsitResponse() {
    *this = ::std::move(from);
  }

  inline GetFriendLsitResponse& operator=(const GetFriendLsitResponse& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriendLsitResponse& operator=(GetFriendLsitResponse&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const GetFriendLsitResponse& default_instance() {
    return *internal_default_instance();
  }
  static inline const GetFriendLsitResponse* internal_default_instance() {
    return reinterpret_cast<const GetFriendLsitResponse*>(
               &_GetFriendLsitResponse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  friend void swap(GetFriendLsitResponse& a, GetFriendLsitResponse& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriendLsitResponse* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(GetFriendLsitResponse* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  GetFriendLsitResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GetFriendLsitResponse>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GetFriendLsitResponse& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const GetFriendLsitResponse& from) {
    GetFriendLsitResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriendLsitResponse* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "test.GetFriendLsitResponse";
  }
  protected:
  explicit GetFriendLsitResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:test.GetFriendLsitResponse)
 private:
  class _Internal;
...
class UserService : public ::PROTOBUF_NAMESPACE_ID::Service {
 ...
 public:
  ...
  virtual void GetFriendLsit(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
class UserService_Stub : public UserService {
 public:
  ...
  void Login(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                       ...
                       ::test::LoginResponse* response,
                       ::google::protobuf::Closure* done);
  void GetFriendLsit(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                       const ::test::GetFriendLsitRequest* request,
                       ::test::GetFriendLsitResponse* response,
                       ::google::protobuf::Closure* done);
 private:
...
// uint32 userid = 1;
inline void GetFriendLsitRequest::clear_userid() {
  _impl_.userid_ = 0u;
}
inline uint32_t GetFriendLsitRequest::_internal_userid() const {
  return _impl_.userid_;
}
inline uint32_t GetFriendLsitRequest::userid() const {
  // @@protoc_insertion_point(field_get:test.GetFriendLsitRequest.userid)
  return _internal_userid();
}
inline void GetFriendLsitRequest::_internal_set_userid(uint32_t value) {
  
  _impl_.userid_ = value;
}
inline void GetFriendLsitRequest::set_userid(uint32_t value) {
  _internal_set_userid(value);
  // @@protoc_insertion_point(field_set:test.GetFriendLsitRequest.userid)
}
...
inline ::test::User_Gender User::_internal_gender() const {
  return static_cast< ::test::User_Gender >(_impl_.gender_);
}
inline ::test::User_Gender User::gender() const {
  // @@protoc_insertion_point(field_get:test.User.gender)
  return _internal_gender();
}
inline void User::_internal_set_gender(::test::User_Gender value) {
  
  _impl_.gender_ = value;
}
inline void User::set_gender(::test::User_Gender value) {
  _internal_set_gender(value);
  // @@protoc_insertion_point(field_set:test.User.gender)
}
...
// .test.ResultCode result = 1;
inline bool GetFriendLsitResponse::_internal_has_result() const {
  return this != internal_default_instance() && _impl_.result_ != nullptr;
}
inline bool GetFriendLsitResponse::has_result() const {
  return _internal_has_result();
}
inline void GetFriendLsitResponse::clear_result() {
  if (GetArenaForAllocation() == nullptr && _impl_.result_ != nullptr) {
    delete _impl_.result_;
  }
  _impl_.result_ = nullptr;
}
inline const ::test::ResultCode& GetFriendLsitResponse::_internal_result() const {
  const ::test::ResultCode* p = _impl_.result_;
  return p != nullptr ? *p : reinterpret_cast<const ::test::ResultCode&>(
      ::test::_ResultCode_default_instance_);
}
inline const ::test::ResultCode& GetFriendLsitResponse::result() const {
  // @@protoc_insertion_point(field_get:test.GetFriendLsitResponse.result)
  return _internal_result();
}
inline void GetFriendLsitResponse::unsafe_arena_set_allocated_result(
    ::test::ResultCode* result) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.result_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:test.GetFriendLsitResponse.result)
}
inline ::test::ResultCode* GetFriendLsitResponse::release_result() {
...
inline ::test::ResultCode* GetFriendLsitResponse::unsafe_arena_release_result() {
  // @@protoc_insertion_point(field_release:test.GetFriendLsitResponse.result)
  
  ::test::ResultCode* temp = _impl_.result_;
  _impl_.result_ = nullptr;
  return temp;
}
inline ::test::ResultCode* GetFriendLsitResponse::_internal_mutable_result() {
...
inline ::test::ResultCode* GetFriendLsitResponse::mutable_result() {
  ::test::ResultCode* _msg = _internal_mutable_result();
  // @@protoc_insertion_point(field_mutable:test.GetFriendLsitResponse.result)
  return _msg;
}
inline void GetFriendLsitResponse::set_allocated_result(::test::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.result_;
  }
  ...
  _impl_.result_ = result;
  // @@protoc_insertion_point(field_set_allocated:test.GetFriendLsitResponse.result)
}

// repeated .test.User friend_list = 2;
inline int GetFriendLsitResponse::_internal_friend_list_size() const {
  return _impl_.friend_list_.size();
}
inline int GetFriendLsitResponse::friend_list_size() const {
  return _internal_friend_list_size();
}
inline void GetFriendLsitResponse::clear_friend_list() {
  _impl_.friend_list_.Clear();
}
inline ::test::User* GetFriendLsitResponse::mutable_friend_list(int index) {
  // @@protoc_insertion_point(field_mutable:test.GetFriendLsitResponse.friend_list)
  return _impl_.friend_list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::test::User >*
GetFriendLsitResponse::mutable_friend_list() {
  // @@protoc_insertion_point(field_mutable_list:test.GetFriendLsitResponse.friend_list)
  return &_impl_.friend_list_;
}
inline const ::test::User& GetFriendLsitResponse::_internal_friend_list(int index) const {
  return _impl_.friend_list_.Get(index);
}
inline const ::test::User& GetFriendLsitResponse::friend_list(int index) const {
  // @@protoc_insertion_point(field_get:test.GetFriendLsitResponse.friend_list)
  return _internal_friend_list(index);
}
inline ::test::User* GetFriendLsitResponse::_internal_add_friend_list() {
  return _impl_.friend_list_.Add();
}
inline ::test::User* GetFriendLsitResponse::add_friend_list() {
  ::test::User* _add = _internal_add_friend_list();
  // @@protoc_insertion_point(field_add:test.GetFriendLsitResponse.friend_list)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::test::User >&
GetFriendLsitResponse::friend_list() const {
  // @@protoc_insertion_point(field_list:test.GetFriendLsitResponse.friend_list)
  return _impl_.friend_list_;
}
...
template <> struct is_proto_enum< ::test::User_Gender> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::test::User_Gender>() {
  return ::test::User_Gender_descriptor();
}
